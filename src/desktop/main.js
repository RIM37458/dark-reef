...
let quitting = false;
let startRevision = 0;
let desktopState = Object.freeze({ running: false, status: null, error: null });
...
function createTray() {
  ...
  tray.setToolTip("Dota 2 好友比赛监测器");
  tray.setContextMenu(
    Menu.buildFromTemplate([
      { label: "打开监测器", click: showWindow },
      { type: "separator" },
      {
        label: "退出",
        click: async () => {
